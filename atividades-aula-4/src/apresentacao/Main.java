...
public class Main {
    ...
    public static void cadastrarAnimalTipo1() {
        ...
        if (zoologico.alocarAnimal(newAnimal, zoologico.getSoViveiros()[key - 1])) {
            System.out.println("Animal cadastrado com sucesso!");
        } else {
            System.out.println("Animal não pode ser cadastrado!");
        }
    ...
    public static void cadastrarAnimalTipo2() {
